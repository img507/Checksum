# 📂📄 Приложение для сравнения контрольных сумм файлов и папок (.NET 10)
...
Если при сравнении папок на больших скоростях вы замечаете высокую нагрузку на процессор со стороны процесса **`Antimalware Service Executable` (Защитник Windows)**, добавьте вашу тестовую папку и исполняемый файл `Directory comparison.exe` в список исключений Windows Defender. 
