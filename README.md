...
*   **Рекурсивное сравнение** папок любого уровня вложенности [4].
...
*   **Многопоточность (`Parallel.ForEach`)** — параллельный расчет хешей на всех доступных ядрах процессора [4].
